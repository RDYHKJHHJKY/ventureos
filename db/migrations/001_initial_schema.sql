...
CREATE INDEX IF NOT EXISTS idx_evidence_items_scan_run_id ON evidence_items(scan_run_id);
CREATE INDEX IF NOT EXISTS idx_passports_asset_id ON passports(asset_id);
